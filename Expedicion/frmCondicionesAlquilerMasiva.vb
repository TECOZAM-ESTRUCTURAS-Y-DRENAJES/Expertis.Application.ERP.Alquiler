Public Class frmCondicionesAlquilerMasiva
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCondicionesAlquilerMasiva))
        ...
        Me.Panel1.Size = New System.Drawing.Size(720, 42)
        Me.Panel1.TabIndex = 2
        '
        'cmbAceptar
        '
        Me.cmbAceptar.DialogResult = System.Windows.Forms.DialogResult.OK
        Me.cmbAceptar.Location = New System.Drawing.Point(307, 8)
        Me.cmbAceptar.Name = "cmbAceptar"
        Me.cmbAceptar.Size = New System.Drawing.Size(106, 27)
        ...
        Me.Grid.ViewName = ""
        '
        'frmCondicionesAlquilerMasiva
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(720, 290)
        Me.Controls.Add(Me.Grid)
        Me.Controls.Add(Me.Panel1)
        Me.Name = "frmCondicionesAlquilerMasiva"
...
#End Region
    ...
    Public Sub AbrirCondicionesAlquiler(ByVal dtAvisos As DataTable)
        Dim f As New Filter(FilterUnionOperator.Or)
        For Each drAvisos As DataRow In dtAvisos.Rows
            f.Add(New NumberFilterItem("IDObra", drAvisos("IDObra")))
        Next

        Dim dt As DataTable = New BE.DataEngine().Filter("vAlquilerfrmCondicionesAlquiler", f)
    ...
    Private Sub Grid_ColumnButtonClick(ByVal sender As System.Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles Grid.ColumnButtonClick
        Select Case e.Column.Key
            Case "CondicionesEspPortes"
                Dim frm As New FormularioTexto
                frm.Text = e.Column.Caption
                frm.Texto = Grid.Value("CondicionesEspPortes") & String.Empty
